...
class PostProcessor(object):
    ...
    def __init__(self, Simulator):
        ...
        self.VSMOW_to_VPDB()
        self.EventAnalyser() 
        self.results_df = pd.DataFrame(columns=['d13C_index', 'Age', 'd13C', 'CaveCacl d13C', 'd13C residual'])
        self.UCa_mmol_mol()
    ...
    def EventAnalyser(self):
        ...
        results = [] 
        all_results = []
        match_found = True  # Flag to check if any match is found
        ...
        # Compare d13C_spel with d13C_data for results with constraints
