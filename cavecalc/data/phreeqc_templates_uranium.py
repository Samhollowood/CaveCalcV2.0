...
# BEDROCK_DISS 3 uses Calcite saturation (more geochemically realistic)
# for use with quantitative dissolutions but has aragonite
BEDROCK_DISS3 = """
EQUILIBRIUM_PHASES
    Pyrite  0   {moles_pyrite}  dissolve_only
    Aragonite 0   Bedrock {moles_bedrock} dissolve_only
        -force_equality
...
EQUILIBRIUM_PHASES
    ...
    Calcite  0   {moles_pyrite}  dissolve_only
    Aragonite  0   {moles_pyrite}  dissolve_only
        -force_equality
...
SS_U = """   # U components:
    ...
    -comp UC[18O]3(s) 0
    -comp U[13C]O3(s) 0
    -comp U[13C]O2[18O](s) 0
    -comp U[13C]O[18O]2(s) 0
    -comp U[13C][18O]3(s) 0
    # -comp U[14C]O3(s) 0
    # -comp U[14C]O2[18O](s) 0
    # -comp U[14C]O[18O]2(s) 0
    # -comp U[14C][18O]3(s) 0    
"""