...
bedrock =              (0, None)
bedrock_mineral =      ['Calcite', 'Dolomite','Aragonite']
...
kinetics_mode = ['multi_step_degassing', 'single_step_degassing', 'allow_supersaturation', 'allow_supersaturation_max', 'degas_only', 'diss_only']
reprecip =      True
totals =        'str'
molalities =    'str'
isotopes =      'str'
precipitate_mineralogy = ['Calcite', 'Aragonite']
tolerance_d13C =  (0, None)
tolerance_d18O = (0, None)
tolerance_DCP =   (0, None)
tolerance_d44Ca =  (0, None)
tolerance_MgCa = (0, None)
