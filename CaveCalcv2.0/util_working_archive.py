...
class PostProcessor(object):
    ...
    def EventAnalyser(self):
        ...
        try:
            ...
            SrCa_data = df[mgca_column[0]].dropna().tolist() if srca_column else None
            BaCa_data = df[mgca_column[0]].dropna().tolist() if baca_column else None
            UCa_data = df[mgca_column[0]].dropna().tolist() if uca_column else None
        ...
        tolerance =   0.5
        mg_tolerance = 0.4  #Define mg_tolerance (adjust as needed)
        dcp_tolerance = 3 
        ...
        SrCa_spel = SrCa_spel * 1000 if MgCa_spel is not None else None 
        BaCa_spel = BaCa_spel * 1000 if MgCa_spel is not None else None 
        UCa_spel = UCa_spel * 1000 if MgCa_spel is not None else None 
